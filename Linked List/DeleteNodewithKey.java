//We are given head of a linked list and a key and we have to delete the node that contains this given key. The following two examples elaborate the problem further.
